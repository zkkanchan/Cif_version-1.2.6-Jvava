...
<header>
  <div class="container">
    <div class="row">
      <div class="container">
        <div id="logo"><a href="index9328.html?route=common/home"><img src="image/catalog/Full%20Logo%20-%20Copy.png" title="Rinnovera" alt="Rinnovera" class="img-responsive" /></a></div>
      </div>
...
<div class="panel panel-default">
          <div class="panel-heading">
            <h4 class="panel-title"><center>Facility</center></h4>
          </div>        
           </div>
  ...
  <h3><?php //echo $result['catname1'];?></h3>
	...
	?>
	 ...
	 <div class="col-sm-3">
          ...
          <div class="memberimage"><a href="#"><img src="image/catalog/facility/<?php  echo $result['Image'];?>" alt="" class="img-responsive" /></a></div> 
             </div></div>
		  <div class="col-sm-9">
          <div class="memberwell">
		  <div class="caption">  <b> Name :</b> <?php echo$result['INSTRUMENTname'];?> <br>                                                              
                                                             <?php echo$result['discription'];?><br>
															
                                                         <font color="#CC0099"> Read More</font></a>
