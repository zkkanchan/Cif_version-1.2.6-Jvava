...
@media only screen and (max-width: 600px) {
  ...
  <div class="col-md-2">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="publication.php" class="list-group-item list-group-item-action bg-light">Publications</a>
        <a href="#" class="list-group-item list-group-item-action bg-light">Teaching</a>
      ...
      <div class="panel-group" id="accordion">
        <div class="panel panel-default">
          <div class="panel-heading">
            <h4 class="panel-title"><center>Research</center></h4>
          </div>
