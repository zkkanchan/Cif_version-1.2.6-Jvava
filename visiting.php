...
<div class="panel panel-default">
          <div class="panel-heading">
            <h4 class="panel-title"><center>Visiting Members</center></h4>
          </div>        
           </div>
    ...
    <?php
include'connect.php';
$sql="select * from tab_member where Type='Visiting' ";
	 ...
	 <div class="col-sm-3">
		  ...
		  <div class="caption">  <b> Name :</b> <?php echo$result['Name'];?> <br> <?php echo$result['Eductionug'];?> <br>                                                              
                                                             ...
                                                             <?php echo$result['phd_college'];?> <br>
                                                               <b>Email :</b><?php echo$result['email'];?><br> <a href="Gallery/pdf/<?php echo$result['pdf'];?>" ><font color="#CC0099"> Read More</font></a>
